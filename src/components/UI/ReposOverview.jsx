...
function ReposOverview() {
    return (
        <section className="bg-eggshell rounded-md m-4 p-4 md:w-full">
            ...
            <article className="text-delft-blue grid grid-cols-2 place-items-center pl-2 pr-2 gap-6 md:grid-cols-4">
                <span>
